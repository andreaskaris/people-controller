...
// List lists all Persons in the indexer.
func (s *personLister) List(selector labels.Selector) (ret []*v1alpha1.Person, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.Person))
	})
	return ret, err
}
...
// List lists all Persons in the indexer for a given namespace.
func (s personNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.Person, err error) {
...
// Get retrieves the Person from the indexer for a given namespace and name.
func (s personNamespaceLister) Get(name string) (*v1alpha1.Person, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("person"), name)
	}
	return obj.(*v1alpha1.Person), nil
}
